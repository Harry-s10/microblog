...
from app.forms import EditProfileForm, EmptyForm, LoginForm, PostForm, RegistrationForm, ResetPasswordForm, \
...
def user(username):
    ...
    form = EmptyForm()
    return render_template('user.html', user=user, posts=posts, form=form, next_url=next_url,
                           prev_url=prev_url)
...
def explore():
    ...
    return render_template('index.html', title='Explore', posts=posts.items, prev_url=prev_url,
                           next_url=next_url)
